...
```
┌──────────────────────────────┬───────┬───────┬───────┬───────┬───────┬───────┬───────┬───────┐
│                        ⛅    │       │  NOW  │  3PM  │  4PM  │  5PM  │  6PM  │  7PM  │  8PM  │
│  ╭───╮               PARTLY  │       │   ☀   │   ☀   │   ⛅   │   ⛅   │   ☁   │   🌧   │   🌧   │
│  │ 7 │2°F            CLOUDY  │  TEMP │  72   │  74   │  73   │  70   │  66   │  62   │  59   │
│  ╰───╯                       │       │                                                       │
│  FEELS 71°                   │       │          ╭───────╮        trend ribbon                │
│  84°  58°                    │       │ ─────────╯       ╰──────╮                             │
│                              │    UV │   7       6       4     ╰──────╮  1       0       0   │
│  2:35 PM · DENVER            │   💧% │   -       -      20      45     60      30       -    │
│                              │  WIND │  ↗8     ↗9     ↑12    ↑14    ↖9     ↖7     ←5        │
└──────────────────────────────┴───────┴───────┴───────┴───────┴───────┴───────┴───────┴───────┘
   ← 208px "Now" zone ─────────→ labels  ← seven 52px hour columns from x262; tap one for detail →
```
